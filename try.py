# main.py (diagnostics-enabled, full history, cluster in response, renamed output fields)
...
#    returns JSON including the precomputed cluster and renamed fields; supports ?debug=true
...
# =========================
# Prompt (renamed output fields; observation/recommendation min-75 instruction)
# =========================
PROMPT_TEMPLATE = """
...
def coerce_to_schema_with_cluster(obj: Dict[str, Any], customer_id: str, cluster_name: str) -> Dict[str, Any]:
    # Prefer new keys; fall back to legacy names for robustness
    out = {
